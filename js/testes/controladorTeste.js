const ControladorTeste = (() => {
    ...
    const camposObrigatorios = Formulario.camposObrigatorios,
        camposBloqueados = Formulario.camposBloqueados,
        camposOcultos = Formulario.camposOcultos;

    const fontes = Formulario.fontes;
